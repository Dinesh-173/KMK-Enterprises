              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute -top-1 -right-1 w-3 h-3 rounded-full"
                    style={{ backgroundColor: '#F4A100' }} />
                </div>
                <div>
                  <span className="text-white font-bold text-xl tracking-tight">KMK</span>
                  <span className="text-teal-DEFAULT text-xs block leading-none font-medium tracking-widest">ENTERPRISES</span>
                </div>
              </motion.div>
            </Link>
